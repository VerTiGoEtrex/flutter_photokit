...
enum FlutterPhotokit_PHAssetCollectionSubtype: SwiftProtobuf.Enum {
  ...
  case any // = 24
  case smartAlbumUnableToUpload // = 25
  case UNRECOGNIZED(Int)
  ...
  init?(rawValue: Int) {
    ...
    case 24: self = .any
    case 25: self = .smartAlbumUnableToUpload
    default: self = .UNRECOGNIZED(rawValue)
    }
  }
  ...
  var rawValue: Int {
    ...
    case .any: return 24
    case .smartAlbumUnableToUpload: return 25
    case .UNRECOGNIZED(let i): return i
    }
  }
...
enum FlutterPhotokit_PHAssetResourceType: SwiftProtobuf.Enum {
  ...
  init?(rawValue: Int) {
    ...
    case 12: self = .adjustmentBaseVideo
    default: self = .UNRECOGNIZED(rawValue)
    }
  }
  ...
  var rawValue: Int {
    ...
    case .adjustmentBaseVideo: return 12
    case .UNRECOGNIZED(let i): return i
    }
  }
...
struct FlutterPhotokit_OpenSettingsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct FlutterPhotokit_OpenSettingsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension FlutterPhotokit_PHAssetCollectionSubtype: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    25: .same(proto: "PH_ASSET_COLLECTION_SUBTYPE_SMART_ALBUM_UNABLE_TO_UPLOAD"),
  ]
}
...
extension FlutterPhotokit_PHAssetResourceType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    12: .same(proto: "PH_ASSET_RESOURCE_TYPE_ADJUSTMENT_BASE_VIDEO"),
  ]
}
...
extension FlutterPhotokit_OpenSettingsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".OpenSettingsRequest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: FlutterPhotokit_OpenSettingsRequest, rhs: FlutterPhotokit_OpenSettingsRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension FlutterPhotokit_OpenSettingsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".OpenSettingsResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: FlutterPhotokit_OpenSettingsResponse, rhs: FlutterPhotokit_OpenSettingsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
